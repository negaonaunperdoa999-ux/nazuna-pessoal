// --- SISTEMA DE REPUTA��O E DEN�NCIAS ---
import fs from 'fs';
...
const getRepRanking = (limit = 10) => {
    ...
    if (rankings.length === 0) {
        return { success: true, message: '?? *RANKING DE REPUTA��O*\n\nNenhum usu�rio com reputa��o ainda!' };
    }
    
    let message = '?? *RANKING DE REPUTA��O*\n\n';
