async function menuDono(prefix, botName = "MeuBot", userName = "Usuário", {
    ...
    automationMenuTitle = "?? SISTEMA & AUTOMA��O",
   menuAssistenteMenuTitle = "🤡⚙️PERSONALIDADE DA ASSISTENTE",
    commandCustomMenuTitle = "??? PERSONALIZA��O DE COMANDOS",
    commandLimitingMenuTitle = "?? LIMITA��O DE COMANDOS",
    ...
    botControlMenuTitle = "? CONTROLE & MANUTEN��O",
