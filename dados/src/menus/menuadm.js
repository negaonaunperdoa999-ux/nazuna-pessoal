export default async function menuadm(prefix, botName = "MeuBot", userName = "Usuário", {
    ...
    separatorIcon = "❁",
    middleBorder = "┊",
    adminMenuTitle = "??? GEST�O DE USU�RIOS",
    managementMenuTitle = "?? GEST�O DO GRUPO",
...
${menuTopBorder}${separatorIcon} *?? SEGURAN�A & PROTE��O*
${middleBorder}
...
${middleBorder}${menuItemIcon}${prefix}modo18
${middleBorder}${menuItemIcon}${prefix}advlink
